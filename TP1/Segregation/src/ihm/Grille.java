...
public class Grille extends javax.swing.JPanel {
    ...
    protected void paintComponent(Graphics g) {
        ...
        for (Agent a : agents) {
            switch (((SatisfactionAgent) a).getType()) {
                case BLANC:
            ...
            g.fillOval(((SatisfactionAgent) a).getX() * CASE_SIZE + CASE_SIZE / 4, ((SatisfactionAgent) a).getY() * CASE_SIZE + CASE_SIZE / 4, CASE_SIZE / 2, CASE_SIZE / 2);
        }
    }
