...
import modele.Main;
import modele.SatisfactionAgent;
...
public class SatisfactionView extends javax.swing.JFrame implements Observer {
    ...
    public void update(Observable o, Object arg) {
        ...
        if (SatisfactionAgent.getSatisfactionBlanc() < Main.SEUIL_SATISFACTION) {
            this.valueFish.setForeground(Color.RED);
        } else {
            this.valueFish.setForeground(Color.BLACK);
        }
        if (SatisfactionAgent.getSatisfactionNoir() < Main.SEUIL_SATISFACTION) {
        ...
        this.valueFish.setText("" + SatisfactionAgent.getSatisfactionBlanc() + " %");
        this.valueSharks.setText("" + SatisfactionAgent.getSatisfactionNoir() + " %");
    }
}
